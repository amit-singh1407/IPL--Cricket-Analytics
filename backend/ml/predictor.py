...
from backend.ml.features import build_player_prediction_frame, build_prediction_feature_row
...
class MatchPredictionService:
    ...
    def _predict_with_model(self, model, features_frame) -> tuple[Any, float | None]:
